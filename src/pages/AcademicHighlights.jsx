      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              icon: "🕋",
              title: "ইসলামি ধর্মতত্ত্ব",
              desc: "তাফসীর, হাদীস, আকীদাহ ও ফিকহসহ ইসলামি বিষয়ে গভীর শিক্ষাদান করা হয়।",
            },
            {
              icon: "👨‍🏫",
            ...
            },
            {
              icon: "🕌",
              title: "ইসলামি পরিবেশ",
              desc: "নৈতিকতা ও ইসলামি মূল্যবোধে গঠিত পরিবেশে শিক্ষার সুযোগ নিশ্চিত করা হয়।",
            },
            {
              icon: "💻",
              title: "আইসিটি ল্যাব",
